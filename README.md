...
- `index.html` → Main HTML file (includes all content)
- `images/` → Contains images used in the portfolio
- Sections included:
  - About Me
  - Skills
  - Portfolio (Catfolio table)
  - Contact Form
  - Footer
...
- **[W3Schools](https://www.w3schools.com/)** → Used for guidance whenever I got stuck.
- **LMS Notes** → Referred to course notes to strengthen my understanding.
- **[W3C Validator](https://validator.w3.org/)** → Used to validate my HTML code. It picked up a few errors, which I corrected successfully.
...
3. Explore CodeSpace Cat’s portfolio!

---

## 📜 License

© 2024 CodeSpace Cat Portfolio. All rights reserved.
